...
{
    public partial class workShiftsUC : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public workShiftsUC(Control _parent)
        {
            InitializeComponent();
            Parent = _parent;
        ...
        private void dimensionRibbonControl_Click(object sender, EventArgs e)
        {

        }

        private void workShiftsUC_Load(object sender, EventArgs e)
        {
            loadData();
        }
  ...
  WHERE [DeletedDate] is null"
        ...
        {
            using (WorkShiftsForm addForm = new WorkShiftsForm())
            {
                addForm.ShowDialog();
                addForm.Dispose();
            }
        ...
        {
            WorkShiftsForm viewForm = new WorkShiftsForm();
            viewForm.currentWorkShiftsGuid = (Guid)workShiftsGridView.GetFocusedRowCellValue("GUID");
            viewForm.edit = true;
            viewForm.view = true;
            viewForm.ShowDialog();
        }
        ...
        {
            using (WorkShiftsForm editForm = new WorkShiftsForm())
            {
                editForm.currentWorkShiftsGuid = (Guid)workShiftsGridView.GetFocusedRowCellValue("GUID");
                editForm.edit = true;
                editForm.ShowDialog();
            }
            loadData();
        ...
        private void workShiftsGridView_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
