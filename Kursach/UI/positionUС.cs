...
{
    public partial class positionUС : UserControl
    {
        ...
        public positionUС(Control _parent)
        {
            InitializeComponent();
            Parent = _parent;
  ...
  WHERE [DeletedDate] is null"
        ...
        private void barButtonItemDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            using (UnitOfWork u = new UnitOfWork())
            {
                ...
                DialogResult d = XtraMessageBox.Show(string.Format("Удалить должность {0} ", currentPosition.NamePosition), "Подтверждение действия", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
