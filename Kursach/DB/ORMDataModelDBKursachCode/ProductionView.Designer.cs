...
namespace Kursach.DB.DBKursach
{
    ...
    [NonPersistent]
    public partial class ProductionView : XPLiteObject
    {
        Guid fGUID;
        public Guid GUID
        {
        ...
        string fProductsGUID;
        [Size(128)]
        public string ProductsGUID
        {
            get { return fProductsGUID; }
            set { SetPropertyValue<string>(nameof(ProductsGUID), ref fProductsGUID, value); }
        }
        ...
        string fMaterialGUID;
        [Size(128)]
        public string MaterialGUID
        {
            get { return fMaterialGUID; }
            set { SetPropertyValue<string>(nameof(MaterialGUID), ref fMaterialGUID, value); }
        }
